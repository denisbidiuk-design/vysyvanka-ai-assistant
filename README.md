...
## <div style="padding:8px; background:#f0f0f0; border-left:6px solid #bd10e0;">🔐 Configuration Example</div>
...
SYSTEM_PROMPT_FILE = "system_prompt_en.md"
HALLUCINATION_TESTS_FILE = "hallucination_tests_en.md"


<div style="padding:8px; background:#f0f0f0; border-left:6px solid #f5a623;">📈 Future Improvements</div>
<div style="padding:12px; border:1px solid #ddd; border-radius:6px;">
<ul>
<li>Product catalog integration</li>
<li>Image-based product recognition</li>
<li>Multi-language support</li>
<li>Admin dashboard</li>
</ul>
</div>

<div style="padding:8px; background:#f0f0f0; border-left:6px solid #4a90e2;">🙌 Feedback</div>
